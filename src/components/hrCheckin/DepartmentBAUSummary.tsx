...
import { DepartmentBAUSummary } from "@/types/hrCheckin";

interface DepartmentBAUSummaryProps {
  summary: DepartmentBAUSummary | null;
}

export function DepartmentBAUSummaryComponent({ summary }: DepartmentBAUSummaryProps) {
  if (!summary) {
    return (
      <Card className="card-elevated">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Department BAU Overview
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center text-muted-foreground py-8">
            Select a department to view BAU overview
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-4">
        ...
        <div className="pt-2 border-t">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>Across {summary.total_members} team members</span>
          </div>
        </div>
      </CardContent>
    </Card>
...
export { DepartmentBAUSummaryComponent as DepartmentBAUSummary };
